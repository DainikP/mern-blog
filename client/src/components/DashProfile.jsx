...
export default function DashProfile() {
  ...
  console.log(imageFileError, imageFileUploadProgress);
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col gap-4">
        <input type="file" accept="image/*" onChange={handleImageChange} ref={filePikerRef} className="hidden" />
        <div
        ...
        {imageFileUploadProgress && <p className="text-center">{imageFileUploadProgress}%</p>}
        <TextInput
          type="text"
          id="username"
